...
```{r, echo=FALSE}
tibble::tribble( ~image_logo, ~description,
...
## Installing packages {#installRpkgs}
...
3. In the box labelled **"Packages"**, type the name of the package you would like to download.  You can do several at once, just separate them with at least one space or a comma.
...
| [`flextable`](https://davidgohel.github.io/flextable/) | 	Functions for Tabular Reporting | 
...
| [`ggeffects`](https://strengejacke.github.io/ggeffects/) | Create Tidy Data Frames of Marginal Effects for 'ggplot' from Model Outputs |
...
### Packages writen by Sarah Schwartz

```{r, eval=FALSE}
devtools::install_github("sarbearschwartz/apaSupp")
devtools::install_github("sarbearschwartz/texreghelpr")
```
